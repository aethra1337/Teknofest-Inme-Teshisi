...
25 Epoch, GPU ile çalıştırma
"""

print("=" * 80)
print("🚀 TEKNOFEST İNME TEŞHİSİ - AKUT SINIFI İYİLEŞTİRME")
print("=" * 80)
...
checkpoint_callback = keras.callbacks.ModelCheckpoint(
    filepath=str(checkpoint_dir / "best_model_akut_iyilestirme.h5"),
...
# Early stopping (daha uzun patience - 25 epoch için)
early_stopping = keras.callbacks.EarlyStopping(
    monitor='val_loss',
    patience=20,  # 15'ten 20'ye çıkarıldı
...
reduce_lr = keras.callbacks.ReduceLROnPlateau(
    monitor='val_loss',
    factor=0.5,
    patience=8,  # 10'dan 8'e düşürüldü (daha hızlı adaptasyon)
    min_lr=1e-7,
    verbose=1,
)
...
# ============================================================================
# ADIM 11: EĞİTİM BAŞLAT (25 EPOCH)
# ============================================================================
print("\n" + "=" * 80)
print("ADIM 11: EĞİTİM BAŞLATILIYOR... 🚀")
print("=" * 80)
print(f"⚠️ 25 EPOCH - Bu işlem 2-4 saat sürebilir!")
...
best_model_path = config.SAVED_MODELS_DIR / "best_model_akut_iyilestirme.h5"
...
history_path = config.RESULTS_DIR / "training_history_akut_iyilestirme.json"
